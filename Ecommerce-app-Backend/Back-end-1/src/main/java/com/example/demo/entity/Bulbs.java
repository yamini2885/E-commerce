...
public class Bulbs {
    ...
    @ElementCollection
    @CollectionTable(name = "bulbs_plants_zone", joinColumns = @JoinColumn(name = "bulb_id"))
    ...
    @ElementCollection
    @CollectionTable(name = "benefits", joinColumns = @JoinColumn(name = "bulb_id"))
    @Column(name = "benefit")
    private List<String> benefits;

    @ElementCollection
    @CollectionTable(name = "steps_to_grow", joinColumns = @JoinColumn(name = "bulb_id"))
    @Column(name = "step")
	...
	public Bulbs(Long id, String commonName, String scientificName, String family, String categories, String origin,
			String climate, List<Integer> zone, String imgUrl, Double price, Double sellingPrice,
	...
	public String toString() {
		return "Bulbs [id=" + id + ", commonName=" + commonName + ", scientificName=" + scientificName + ", family="
