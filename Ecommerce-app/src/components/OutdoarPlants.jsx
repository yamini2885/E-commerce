...
import "./OutdoarPlants.css"
import Outdoar_Plants from "../../db/Outdoar_Plants.json"
...
const OutDoarPlants = () => {
  ...
  useEffect(() => {
    fetch(Outdoar_Plants)
      
       .then(() => setPlants(Outdoar_Plants["Outdoar_plants1"]))
