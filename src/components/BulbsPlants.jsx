...
import "./BulbsPlants.css";   // use a bulbs version of CSS (same as Indoor)
...
const BulbsPlants = () => {
  ...
  useEffect(() => {
    fetch("/db/BulbsPlants.json")   // <-- change JSON path
      .then((res) => res.json())
      .then((data) => setPlants(data.BulbsPlants))  // <-- read array
